...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[state]', ['1'=>__('Yes'), '0'=>__('No')], $row['state']); ?>
        </div>
    </div>
