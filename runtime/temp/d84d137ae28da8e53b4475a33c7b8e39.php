...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-level" class="control-label col-xs-12 col-sm-2"><?php echo __('Level'); ?>: 0 普通会员 1 vip</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-level" data-rule="required" class="form-control" name="row[level]" type="number" value="<?php echo $row['level']; ?>" max="1" min="0">
        </div>
    </div>
